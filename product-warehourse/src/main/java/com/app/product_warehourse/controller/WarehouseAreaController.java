...
public class WarehouseAreaController {
    ...
    @PutMapping("/{id}")
    public WarehouseAreaResponse updateWarehouseArea(@PathVariable Long id, @RequestBody WarehouseAreaRequest request) {
        return warehouseAreaService.updateWarehouseArea(id, request);
    }
